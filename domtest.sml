...
(* Put this in because for some reason it will print the top val behind
		val domt0 in the results,so (0,0) for val a would show up there if
		I didn't include this irrelevant statement. *)
val nothing = print;
val a = print dt0;
val b = print dt1;
val c = print dt2;
